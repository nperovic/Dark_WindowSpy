...
WinSpyGui() {
    ...
    oGui.SetFont(, "Microsoft JhengHei UI")
    oGui.SetFont(, "源泉圓體 R")
    ...
    oGui.Add("Text", "xp+48 yp", "Follow Mouse").OnEvent("Click", ToggleCheck)
    ...
    oGui.Add("Checkbox", "x-17 Right vCtrl_IsSlow")
    ...
    for ctrl in oGui {
        if ctrl Is Gui.Edit
            ctrl.Opt("cWhite Background" oGui.BackColor)
        ctrl.Opt("cF8F8F8")
